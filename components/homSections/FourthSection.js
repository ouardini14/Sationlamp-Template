...
export default function FourthSection() {
  return (
    ...
    <div className=' px-5 flex flex-col gap-10  items-center justify-center text-center lg:pl-36 xl:pl-52 md:items-start md:text-start md:justify-start'>
      <Title title="Prenota una chiamata con noi" line={true} style="text-3xl md:text-5xl  " />
      <p className='text-[#01133F] font-medium  text-2xl'>Prenota ora una chiamata con in nostri esperti per realizzare il progetto della tua azienda  </p>
