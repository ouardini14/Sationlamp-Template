...
export default function Privacy_Policy() {
  return (
    <div
      className="px-6 md:px-20 lg:px-28 prose-p:m-0 prose-h1:m-2 prose-h1:pt-5 prose-h1:pb-2 prose-h2:pt-3 prose-li:py-0  prose-h2:m-2  font-Garamond prose p-10 prose-p:font-medium text-black  max-w-none prose-h2:font-semibold prose-h1:font-medium 
      lg:prose-h1:text-7xl  lg:prose-h2:text-3xl
      pt-44
      md:pt-52"
    >
      <div className="font-semibold  flex flex-col items-center justify-center gap-2  ">
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              Agreement) refers to soluzioneamazon.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              Website refers to soluzioneamazon, accessible from{" "}
              <a
                href="https://www.freeprivacypolicy.com/live/soluzioneamazon.it"
                rel="noreferrer noopener"
                target="_blank"
              >
                soluzioneamazon.it
        ...
        <ul>
          <li>
            <p>
              By email:&nbsp;
              <a href="mailto:info@bdstrategy.com">info@bdstrategy.com</a>
            </p>
          </li>
        </ul>
      </div>
